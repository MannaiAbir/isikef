<?php  
 ...
 {  
      ...
      {  
           ...
           {  
                $query = "SELECT * FROM inscription WHERE mail = :username AND password = :password";  
        ...
        function test() {
            ...
            if (login.length === 0 || pwd.length === 0) {
                ...
                if (login.substring(login.indexOf(a)) != '@isikef.u-jendouba.tn') {
                    alert("Votre de mot de passe doit avoir une adresse @isikef.u-jendouba.tn");
                    return false;
                } 
            }
        }
