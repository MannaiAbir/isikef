...
<body>
  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center justify-content-between position-relative">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="index.php"><span>Institut Supérieur d'Informatique du Kef</span></a></h1>
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
            ...
            <article class="blog-details">
              ...
              <h2 class="title">تهانينا للسيد محمد الحيوني، مدير المعهد العالي للإعلامية بالكاف حصوله على التأهيل الجامعي في الاتصالات</h2>

              <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="media1.html">Mouhamed hyaouni </a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="media1.html"><time datetime="2023-02-25">Fevr 25, 2023</time></a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="media1.html">12 Comments</a></li>
                </ul>
              </div><!-- End meta top -->
              ...
              <div class="content">
                ...
                <img src="assets/img/media/1-1.jpg" class="img-fluid" alt="">
                <img src="assets/img/media/1-2.jpg" class="img-fluid" alt="">
                <img src="assets/img/media/1-3.jpg" class="img-fluid" alt="">
